...
public class Testing_Practice {
    ...
    @Parameters ("url")
	@BeforeTest
	public void setUp(ITestContext context , String url) throws IOException {
	...
	@Test(priority = 1)
	public void userDetailes() throws InterruptedException, IOException {
		 
		driver.findElement(By.id("name")).sendKeys("khan");
		driver.findElement(By.id("email")).sendKeys("khan456@gnail.com");
		Thread.sleep(2500);
